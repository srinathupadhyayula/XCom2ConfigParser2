...
public class BuildControllerErrorHandlingTests : IDisposable
{
    ...
    [Fact]
    public void EnableDebugAndFinalRelease_ThrowsException()
    {
        // Arrange
        ...
        // Act & Assert
        Assert.ThrowsAny<Exception>(() => controller.EnableFinalRelease());
    }
    ...
    public async Task InvokeBuildAsync_ThrowsException_WhenGamePathInvalid()
    {
        ...
        // Assert
        Assert.False(result.Success);
        Assert.Contains(result.Errors, e => e.Contains("GamePath"));
    }
    ...
    public async Task InvokeBuildAsync_ThrowsException_WhenModNameEmpty()
    {
        ...
        // Assert
        Assert.False(result.Success);
        Assert.Contains(result.Errors, e => e.Contains("ModName"));
    }
    ...
    public async Task InvokeBuildAsync_ThrowsException_WhenProjectRootEmpty()
    {
        ...
        // Assert
        Assert.False(result.Success);
        Assert.Contains(result.Errors, e => e.Contains("ProjectRoot"));
    }
