...
public sealed class FileProcessor
{
    ...
    /// <param name="loggerFactory">The logger factory to create internal loggers.</param>
        ...
        ModSrcPathCache? modSrcCache = null)
    {
        ...
        _structValidator = structValidationEnabled
            ? new StructMemberValidator(settings, loggerFactory, enabled: true, modSrcCache: modSrcCache)
            : null;
    }
    ...
    {
        _logger.LogDebug("Saving caches...");
