...
public static class TableFormatter
{
    ...
    public static string FormatTimings(IEnumerable<TimingRecord> timings, TimeSpan totalDuration)
    {
        ...
        {
            new TimingRecord("Total Duration", totalDuration.TotalSeconds, ""),
            new TimingRecord("Unaccounted Time", totalDuration.TotalSeconds - accountedTime, "")
        }).ToList();
